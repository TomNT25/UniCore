PRINT 'Seeding Users, Profiles, Person IDs, MFA, Tokens, External Logins & Auth Logs...';

-- 1. Admin User & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'admin')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-admin-001', 'USR-00001', 'admin', 'admin@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-admin-001', 1, 1);
...
-- 2. Lecturer User 1 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'lecturer1')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-lecturer-001', 'USR-00002', 'lecturer1', 'lecturer1@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-lecturer-002', 1, 1);
...
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-001', 'USR-00003', 'STD-00001', 'student1', 'student1@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-001', 'PRF-00003', 'usr-student-001', 'Van A', 'Tran', 'Tran Van A', '0987654321', 'Male', '2003-08-20');
END;

-- 4. Student User 2 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student2')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-002', 'USR-00004', 'STD-00002', 'student2', 'student2@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-002', 'PRF-00004', 'usr-student-002', 'Thi B', 'Le', 'Le Thi B', '0976543210', 'Female', '2003-11-12');
END;

-- 5. Lecturer User 2 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'lecturer2')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-lecturer-002', 'USR-00005', 'lecturer2', 'lecturer2@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-lecturer-002', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-lecturer-002', 'PRF-00005', 'usr-lecturer-002', 'Hoang', 'Le', 'Dr. Le Hoang', '0911223344', 'Male', '1982-03-10');
END;

-- 6. Lecturer User 3 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'lecturer3')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-lecturer-003', 'USR-00006', 'lecturer3', 'lecturer3@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-lecturer-002', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-lecturer-003', 'PRF-00006', 'usr-lecturer-003', 'Minh', 'Pham', 'Dr. Pham Minh', '0922334455', 'Male', '1980-07-25');
END;

-- 7. Student User 3 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student3')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-003', 'USR-00007', 'STD-00003', 'student3', 'student3@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-003', 'PRF-00007', 'usr-student-003', 'Van C', 'Hoang', 'Hoang Van C', '0965432109', 'Male', '2004-01-15');
END;

-- 8. Student User 4 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student4')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-004', 'USR-00008', 'STD-00004', 'student4', 'student4@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-004', 'PRF-00008', 'usr-student-004', 'Thi D', 'Pham', 'Pham Thi D', '0954321098', 'Female', '2004-04-18');
END;

-- 9. Student User 5 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student5')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-005', 'USR-00009', 'STD-00005', 'student5', 'student5@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-005', 'PRF-00009', 'usr-student-005', 'Van E', 'Nguyen', 'Nguyen Van E', '0943210987', 'Male', '2004-09-05');
END;

-- 10. Student User 6 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student6')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-006', 'USR-00010', 'STD-00006', 'student6', 'student6@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-006', 'PRF-00010', 'usr-student-006', 'Van F', 'Vo', 'Vo Van F', '0932109876', 'Male', '2004-06-30');
END;

-- 11. Student User 7 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student7')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-007', 'USR-00011', 'STD-00007', 'student7', 'student7@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-007', 'PRF-00011', 'usr-student-007', 'Thi G', 'Do', 'Do Thi G', '0921098765', 'Female', '2004-12-14');
END;

-- 12. Staff User 1 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'staff1')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-staff-001', 'USR-00012', 'staff1', 'staff1@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-staff-004', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-staff-001', 'PRF-00012', 'usr-staff-001', 'Thi H', 'Bui', 'Bui Thi H', '0910987654', 'Female', '1992-02-28');
END;

-- 13. Head User 1 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'head1')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-head-001', 'USR-00013', 'head1', 'head1@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-head-005', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-head-001', 'PRF-00013', 'usr-head-001', 'Quoc I', 'Dang', 'Dr. Dang Quoc I', '0909876543', 'Male', '1978-10-02');
END;

-- 14. Advisor User 1 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'advisor1')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-advisor-001', 'USR-00014', 'advisor1', 'advisor1@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-advisor-006', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-advisor-001', 'PRF-00014', 'usr-advisor-001', 'Van K', 'Ngo', 'Master Ngo Van K', '0898765432', 'Male', '1986-11-19');
END;

-- 15. Student User 8 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student8')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-008', 'USR-00015', 'STD-00008', 'student8', 'student8@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-008', 'PRF-00015', 'usr-student-008', 'Van L', 'Truong', 'Truong Van L', '0887654321', 'Male', '2004-03-22');
END;

-- 16. Student User 9 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student9')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-009', 'USR-00016', 'STD-00009', 'student9', 'student9@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-009', 'PRF-00016', 'usr-student-009', 'Thi M', 'Dinh', 'Dinh Thi M', '0876543210', 'Female', '2004-07-11');
END;

-- 17. Student User 10 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student10')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-010', 'USR-00017', 'STD-00010', 'student10', 'student10@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-010', 'PRF-00017', 'usr-student-010', 'Van N', 'Phung', 'Phung Van N', '0865432109', 'Male', '2004-10-29');
END;

-- 18. Student User 11 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student11')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-011', 'USR-00018', 'STD-00011', 'student11', 'student11@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-011', 'PRF-00018', 'usr-student-011', 'Thi P', 'Luu', 'Luu Thi P', '0854321098', 'Female', '2004-05-08');
END;

-- 19. Student User 12 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student12')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-012', 'USR-00019', 'STD-00012', 'student12', 'student12@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-012', 'PRF-00019', 'usr-student-012', 'Van Q', 'Duong', 'Duong Van Q', '0843210987', 'Male', '2004-02-17');
END;

-- 20. Student User 13 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student13')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-013', 'USR-00020', 'STD-00013', 'student13', 'student13@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-013', 'PRF-00020', 'usr-student-013', 'Thi R', 'Mai', 'Mai Thi R', '0832109876', 'Female', '2004-08-23');
END;

-- 21. Student User 14 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'student14')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [student_code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-student-014', 'USR-00021', 'STD-00014', 'student14', 'student14@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-student-003', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-student-014', 'PRF-00021', 'usr-student-014', 'Van S', 'Trieu', 'Trieu Van S', '0821098765', 'Male', '2004-11-04');
END;

-- 22. Proctor User 1 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'proctor1')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-proctor-001', 'USR-00022', 'proctor1', 'proctor1@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-proctor-016', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-proctor-001', 'PRF-00022', 'usr-proctor-001', 'Van T', 'La', 'La Van T', '0810987654', 'Male', '1988-06-12');
END;

-- 23. Dorm Manager 1 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'dormmgr1')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-dormmgr-001', 'USR-00023', 'dormmgr1', 'dormmgr1@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-dormmgr-018', 1, 1);

    INSERT INTO [dbo].[user_profiles] ([id], [code], [user_id], [first_name], [last_name], [full_name], [phone_number], [gender], [birth_date])
    VALUES ('prof-dormmgr-001', 'PRF-00023', 'usr-dormmgr-001', 'Thi U', 'Kieu', 'Kieu Thi U', '0809876543', 'Female', '1984-09-30');
END;

-- 24. Accountant User 1 & Profile
IF NOT EXISTS (SELECT 1 FROM [dbo].[users] WHERE [username] = 'accountant1')
BEGIN
    INSERT INTO [dbo].[users] ([id], [code], [username], [email], [password_hash], [provider], [role_id], [is_active], [is_email_verified])
    VALUES ('usr-accountant-001', 'USR-00024', 'accountant1', 'accountant1@unicore.edu.vn', '$2y$10$qlgpKqrNF4R7SjWw5klB/OGGvOArWISvZiALfIGnt04G.PvwvdCA.', 'system', 'role-accountant-009', 1, 1);
