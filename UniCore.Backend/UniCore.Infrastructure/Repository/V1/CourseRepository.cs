...
namespace UniCore.Infrastructure.Repository.V1
{
    public class CourseRepository : RepositoryEFCoreBase<Course>, ICourseRepository
    {
        ...
        public async Task<CursorPaginationResponse<Course>> SearchActiveCursorAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (hasNextPage && items.Count > 0)
            {
                ...
                var prop = typeof(Course).GetProperties()
            ...
            return new CursorPaginationResponse<Course>
            {
                Items = items,
